                ...
                int num_aux_buffers )
{
    ...
    // LINEAR (was NEAREST): the LFB texture carries the game's 2D layer (menus,
    // briefings, intro), which is pillarboxed up to the full screen. Bilinear
    // smooths the 640-wide source instead of showing hard upscale blocks.
